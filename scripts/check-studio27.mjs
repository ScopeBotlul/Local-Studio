...
export async function checkStudio27({getPage,invoke,artifactRoot,record,defer,pid}){
 ...
 await assert.rejects(invoke('image_generate',{request:{...request,width:641}}),/image_dimensions/);await assert.rejects(invoke('image_generate',{request:{...request,width:4096,height:4096}}),/image_dimensions/);
