...
- Portable Ausgabe: zeigt neue Versionen und öffnet die GitHub-Veröffentlichung. App schließen und Programmdateien einschließlich `image-runtime` und `video-runtime` aus dem ZIP ersetzen. **Local-Studio-Data behalten.** Kein automatischer Installer oder Registry-Eintrag.
