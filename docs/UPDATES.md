...
- Portable Ausgabe: zeigt neue Versionen und öffnet die GitHub-Veröffentlichung. App schließen und Programmdateien einschließlich `image-runtime`, `video-runtime`, `assistant-runtime` und `speech-runtime` aus dem ZIP ersetzen. **Local-Studio-Data behalten.** Kein automatischer Installer oder Registry-Eintrag.
