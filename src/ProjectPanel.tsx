...
export default function ProjectPanel({ shortcuts,maxUndo,controller: c, language, disabled, changed }: { shortcuts:Shortcuts;maxUndo:number;controller: ReturnType<typeof useProject>; language: Language; disabled: boolean; changed: boolean }) {
