...
export const editorActivity:{pending:Promise<unknown>|null;draft:boolean;persisted:boolean;cancelBatch:(()=>void)|null}={pending:null,draft:false,persisted:true,cancelBatch:null};
