...
export interface StudioProject { locked?:boolean;restricted?:boolean; creative?:Creative; id: string; name: string; path: string | null; version: string | null; request: ImageRequest | null; model: { name: string; sha256: string; source: string } | null; assets: ProjectAsset[]; removed: ProjectAsset[]; dirty: boolean; recovery: boolean }
